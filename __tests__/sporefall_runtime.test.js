...
test('shadowmire collapse now routes into blackout and Sporefall instead of the old immediate ruins path', () => {
  expect(scenes.SCENE_SHADOWMIRE_DYING_BIRDS.choices[0].nextSceneSuccess).toBe('SCENE_SHADOWMIRE_ROADSIDE_CORPSE');
  expect(scenes.SCENE_SHADOWMIRE_DYING_BIRDS.choices[0].nextSceneFail).toBe('SCENE_SHADOWMIRE_ROADSIDE_CORPSE');
