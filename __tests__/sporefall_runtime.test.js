...
test('Aodhan clues no longer let Sporefall shortcut directly into the late Hushbriar route', () => {
  gameState.flags.sporefall_eoin_met = true;
  gameState.flags.sporefall_eoin_talked = true;
  ...
  expect(scene.choices.some((choice) => choice.text.includes("follow Aodhan's trail toward Hushbriar"))).toBe(false);
});
