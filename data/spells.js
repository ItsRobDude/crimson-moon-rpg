export const spells = {
    "firebolt": {
        ...
        concentration: false,
        targeting: { type: "single", side: "enemy", rangeFeet: 120 },
        type: "attack",
        attack: true,
        damage: "1d10",
        damageType: "fire",
    ...
    "ray_of_frost": {
        ...
        durationType: "instant",
        concentration: false,
        targeting: { type: "single", side: "enemy", rangeFeet: 60 },
        type: "attack",
        attack: true,
        damage: "1d8",
        damageType: "cold",
    ...
    "guidance": {
        ...
        concentration: true,
        targeting: { type: "single", side: "ally", rangeFeet: 5 },
        type: "buff",
    ...
    "bless": {
        ...
        durationType: "concentration",
        concentration: true,
        targeting: { type: "single", side: "ally", rangeFeet: 30, maxTargets: 3 },
        maxTargets: 3,
        type: "buff",
        effect: {
            id: "blessed",
    ...
    "shield_of_faith": {
        ...
        durationType: "concentration",
        concentration: true,
        targeting: { type: "single", side: "ally", rangeFeet: 60 },
        type: "buff",
        effect: {
            id: "shield_of_faith",
            name: "Shield of Faith",
    ...
    "shield": {
        ...
        durationType: "turns",
        concentration: false,
        targeting: { type: "single", side: "self", rangeFeet: 0 },
        type: "reaction",
        effect: {
            id: "shield_spell",
            name: "Shield",
